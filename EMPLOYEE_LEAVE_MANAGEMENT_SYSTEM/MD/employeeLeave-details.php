<?php
    ...
    $mdremarkdate=date('Y-m-d G:i:s ', strtotime("now"));
    ...
    $sql="UPDATE tblleaves set MDRemark=:description,Status=:status,MDRemarkDate=:mdremarkdate where id=:did";
    $query = $dbh->prepare($sql);
    $query->bindParam(':description',$description,PDO::PARAM_STR);
    $query->bindParam(':status',$status,PDO::PARAM_STR);
    $query->bindParam(':mdremarkdate',$mdremarkdate,PDO::PARAM_STR);
    $query->bindParam(':did',$did,PDO::PARAM_STR);
    $query->execute();
...
<head>
    ...
    <title>MD Panel - Employee Leave</title>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown"> MD <i class="fa fa-angle-down"></i></h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    echo htmlentities($result->MDRemark);
                                    }
                                    ?></td>
                                </tr>

                                <tr>
                                <td ><b>MD Action On: </b></td>
                                    <td><?php
                                    if($result->MDRemarkDate==""){
                                    echo "NA";  
                                    }
                                    else{
                                    echo htmlentities($result->MDRemarkDate);
                                    }
                                    ?></td>
                                </tr>
